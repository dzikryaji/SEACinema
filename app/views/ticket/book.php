    ...
    <div class="container-fluid mb-4">
        <?php for ($index = 1; $index <= 64; $index++) : ?>
            <?php if ($index % 8 == 1) : ?>
                ...
                <?php endif; ?>
                <div class="col-1">
                    <input class="form-check-input w-100" type="checkbox" value="<?= $index ?>" id="Seat_<?= $index ?>" name="Seat_<?= $index ?>">
        ...
        <div class="row mt-4 justify-content-center">
            <input type="submit" value="Book Ticket" class="btn btn-primary w-50">
        </div>
    </div>
</form>
</section>